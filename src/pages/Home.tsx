...
export const Home: React.FC<HomeProps> = ({ currentLang, onLangChange, onPageChange }) => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-sky-100 via-white to-sky-100/80 text-zinc-650 flex flex-col justify-between font-sans overflow-x-hidden ${isRtl ? 'text-right' : 'text-left'}`}>
